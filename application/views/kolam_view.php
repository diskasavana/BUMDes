...
<body>
  ...
  <section class="pt-0">
      <div class="container">
        <div class="row">
          <div class="col-lg-14">
            <h2 class="text-center">Dokumentasi Kolam Renang Pandowoharjo</h2>
          </div>
        </div>
        <div class="row row-cols-1 row-cols-md-3 justify-content-center g-4">
          <div class="col">
            <div class="card">
              <img src="<?= base_url('assets/img/KOLAM/KOLAM1.jpg') ?>" class="card-img-top" alt="...">
            </div>
          </div>
          <div class="col">
            <div class="card">
              <img src="<?= base_url('assets/img/KOLAM/KOLAM2.jpg') ?>" class="card-img-top" alt="...">
            </div>
          </div>
          <div class="col">
            <div class="card">
              <img src="<?= base_url('assets/img/KOLAM/KOLAM3.jpg') ?>" class="card-img-top" alt="...">
            </div>
          </div>
          <div class="col">
            <div class="card">
              <img src="<?= base_url('assets/img/KOLAM/KOLAM4.jpg') ?>" class="card-img-top" alt="...">
            </div>
          </div>
          <div class="col">
            <div class="card">
              <img src="<?= base_url('assets/img/KOLAM/KOLAM5.jpg') ?>" class="card-img-top" alt="...">
            </div>
          </div>
          <div class="col">
            <div class="card">
              <img src="<?= base_url('assets/img/KOLAM/KOLAM6.jpg') ?>" class="card-img-top" alt="...">
            </div>
          </div>
          <div class="col">
            <div class="card">
              <img src="<?= base_url('assets/img/KOLAM/KOLAM7.jpg') ?>" class="card-img-top" alt="...">
            </div>
          </div>
          <div class="col">
            <div class="card">
              <img src="<?= base_url('assets/img/KOLAM/KOLAM8.jpg') ?>" class="card-img-top" alt="...">
            </div>
          </div>
          <div class="col">
            <div class="card">
              <img src="<?= base_url('assets/img/KOLAM/KOLAM9.jpg') ?>" class="card-img-top" alt="...">
            </div>
          </div>
        </div>
      </div>
